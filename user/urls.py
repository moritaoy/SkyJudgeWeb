...
urlpatterns = [
    ...
    path('create/done', views.UserCreateDone.as_view(), name='user_create_done'),
    path('create/complete/<token>/', views.UserCreateComplete.as_view(), name='user_create_complete'),
]